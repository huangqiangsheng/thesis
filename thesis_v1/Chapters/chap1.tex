...
第二章介绍了硅基混合集成III-V波导中两方面的设计。第一方面是量子阱结构的设计。首先介绍了用于电吸收光调制器量子阱结构的计算仿真方法，然后介绍了利用退火算法设计量子阱结构的思路。并且提供了利用退火算法设计偏振不敏感电吸收光调制器的量子阱结构的例子。随后，我们比较了自己设计和测试的结果。第二方面是和波导尺寸的设计，分析了混合集成III-V波导中硅波导的宽度和各个外延层宽度和高度在光学和电学上对光调制器的影响。
