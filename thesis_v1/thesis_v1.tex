...
%英文题目
\Etitle{Study of Novel Optical Modulator}
% 如果一行写不下，同中文题目设定，一行写不下则写两行，不需要就注释掉
\Etitletl{Based on Silicon-on-Insulator Platform}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 英文题名
\englishtitle{Study of Novel Optical Modulator}
% 如果题名一行写不下，就写到第二行，不需要则将其注释掉
\englishtitletl{Based on Silicon-on-Insulator Platform}
