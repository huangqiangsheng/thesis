...
%英文题目
\Etitle{Study of Novel Low Driving Voltage}
% 如果一行写不下，同中文题目设定，一行写不下则写两行，不需要就注释掉
\Etitletl{Silicon Based Optical Modulator}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 英文题名
\englishtitle{Study of Novel Low Driving Voltage}
% 如果题名一行写不下，就写到第二行，不需要则将其注释掉
\englishtitletl{Silicon Based Optical Modulator}
